...
import ShopifyBuyButton_HLU from './ShopifyBuyButton_HLU'; // Import the module
...
const Release_HLU: React.FC<HLUProps> = ({ genre }) => {
...
type musicData = {
    ...
    const musicTracks: musicData[] = [
        {
          trackName: "He Loves You",
          artistName: "Bai-ee",
          src: "https://github.com/Bai-ee/public_audio/raw/main/He_Loves_You_BAI-EE.mp3",
      }, 
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-gray-800">
      <img src="https://i.ibb.co/W28s2SM/a2777537223-16.jpg"
