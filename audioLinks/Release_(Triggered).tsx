...
import ShopifyBuyButton from './ShopifyBuyButton_Triggered'; // Import the module


interface TriggeredProps {
  genre: string[]; // Adding a genre prop
  // Include other props if there are any
}

const Release_Triggered: React.FC<TriggeredProps> = ({ genre }) => {
    ...
    const musicTracks: musicData[] = [
        {
          ...
          src: " https://github.com/Bai-ee/public_audio/raw/main/Secret%20Studio%20-%20Triggered.mp3?raw=true",
          },
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-gray-800">
      <img src="https://i.ibb.co/YBD3tys/B76122-EB-0-F0-E-406-E-8926-369331-D29-A5-F.png"
...
export default Release_Triggered;
