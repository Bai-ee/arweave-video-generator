...
import ShopifyBuyButton from './ShopifyBuyButton_HomeBase'; // Import the module
...
const Release_HomeBase: React.FC<HomeBaseProps> = ({ genre }) => {
    ...
    const musicTracks: musicData[] = [
        {
          trackName: "TEST",
          artistName: "Bai-ee",
          src: "https://github.com/Bai-ee/public_audio/raw/main/Home_Bass_(Secret_Studio_vs_Dmarc_Cantu)_SCS01.mp3",
        },  
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-gray-800">
      <img src="https://i.ibb.co/bz33SGr/809-D2-D67-3218-4212-8-F4-B-C5-A7253-E0-CE5.png"
...
export default Release_HomeBase;
