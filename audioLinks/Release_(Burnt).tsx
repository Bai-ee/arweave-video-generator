...
import ShopifyBuyButton from './ShopifyBuyButton_Burnt'; // Import the module
...
import et005 from './et005hand.jpg'; // Import the image
{/* <img src={et005} */}
...
const Release_Burnt: React.FC<BurntProps> = ({ genre }) => {
    ...
    const musicTracks: musicData[] = [
        {
          ...
          src: "https://github.com/Bai-ee/public_audio/raw/main/Bai-ee_(Burnt)Preview.mp3",
        },  
      ];
