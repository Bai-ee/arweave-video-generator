...
import ShopifyBuyButton_Walk from './ShopifyBuyButton_Walk'; // Import the module
...
const Release_Walk: React.FC<WalkProps> = ({ genre }) => {
    ...
    const musicTracks: musicData[] = [
        {
          trackName: "Walk",
          artistName: "Bai-ee",
          src: "https://github.com/Bai-ee/public_audio/raw/main/Walk_Preview.mp3",
      }, 
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-gray-800">
      <img src="https://i.ibb.co/C9t1L7T/5-A7-FF93-D-9532-4-D07-97-EA-0-EC9-A3-C3994-D-2.png"
