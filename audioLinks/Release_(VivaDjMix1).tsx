...
// import ShopifyBuyButtonRunner from './ShopifyBuyButton_Runner'; // Import the module


interface VivaDjMix1Props {
  genre: string[]; // Adding a genre prop
  // Include other props if there are any
}

const Release_VivaDjMix1: React.FC<VivaDjMix1Props> = ({ genre }) => {
    ...
    const musicTracks: musicData[] = [
        {
          trackName: "TEST",
          artistName: "Bai-ee",
          src: "https://github.com/Bai-ee/public_audio/raw/main/Runner_Secret_Studio.mp3",
        },  
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-black">
      <img src="https://i.ibb.co/pdL8qX4/Frame-15625.jpg"
    ...
    <div className="mt-6 relative">
      ...
      {/* // */}
        ...
        {/* <div className="playButtonCont"> <div className="releasePlayer">
          ...
          <div className="
          uppercase leading-tight mt-auto text-sm 
          w-full h-20   text-yellow-75 text-center
          rounded-md flex items-center justify-center checkoutBg">
                      <a href=" https://audius.co/luisbaro/guest-mix-bai-ee" target="_blank" rel="noopener noreferrer" className="">

            LISTEN NOW
            </a>
            {/* <ShopifyBuyButtonRunner /> */}
          </div>
...
export default Release_VivaDjMix1;
