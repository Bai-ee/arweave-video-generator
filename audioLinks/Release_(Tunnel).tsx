...
import ShopifyBuyButton_Tunnel from './ShopifyBuyButton_Tunnel'; // Import the module
...
const Release_Tunnel: React.FC<TunnelProps> = ({ genre }) => {
    ...
    const musicTracks: musicData[] = [
        {
          ...
          src: "https://github.com/Bai-ee/public_audio/raw/main/Secret%20Studio%20-%20Tunnel%20Vision.mp3",
      }, 
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-gray-800">
      <img src="https://i.ibb.co/C1YTXg9/D6-CE9555-2007-447-C-8-BB5-DDA1-FE33-CE25.png"
