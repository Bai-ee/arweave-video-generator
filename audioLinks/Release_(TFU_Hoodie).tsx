...
import ShopifyBuyButton from './ShopifyBuyButton_Hoodie_TFU'; // Import the module


interface TFU_HoodieProps {
  genre: string[]; // Adding a genre prop
  // Include other props if there are any
}

const Release_TFU_Hoodie: React.FC<TFU_HoodieProps> = ({ genre }) => {
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-gray-800">
      <img src="https://i.ibb.co/X4zcmnf/TFU-Shirt-Graphic-1.jpg"
      alt="art cover" loading="lazy" className="w-full object-cover object-top transition duration-500 group-hover:scale-105" />    
    </div>
    <div className="mt-6 relative">
      <div className="mt-6 mb-2 relative flex flex-col sm:flex-row justify-evenly gap-2">
      <div className="playButtonCont ">
            
        <h3 className="release_name">
        "TFU HOODIE"
        </h3>
        <p className="mt-0  text-yellow-75 text-center">
        Logo Pull Over

        </p>
        {/* <h3 className="text-2xl font-semibold text-yellow-75 text-center">
        <br></br>
        </h3> */}
        <div className="flex flex-row w-full justify-center p-2 pb-0 rounded-md gap-2 px-0">
          {/* <div className="playButtonCont h-20 w-20 border border-yellow-75  text-black text-center rounded-md">
            <div className="releasePlayer">
              <AudioPlayer
              style={{ backgroundColor: "#ffffff" }}
              src={musicTracks[9].src}
          ...
          <div className="
          uppercase leading-tight  text-lg font-mathias 
          w-full h-20 text-yellow-75 text-center
          rounded-md flex items-center justify-center soldoutBg pt-0 mt-0">
           SOLD OUT {/* <ShopifyBuyButton /> */}
          </div>
        </div>
      </div>
    </div>
...
export default Release_TFU_Hoodie;
