...
import ShopifyBuyButton_Hitit from './ShopifyBuyButton_HitIt'; // Import the module


interface HititProps {
  genre: string[]; // Adding a genre prop
  // Include other props if there are any
}

const Release_Hitit: React.FC<HititProps> = ({ genre }) => {
...
type musicData = {
    ...
    const musicTracks: musicData[] = [
        {
          trackName: "Let Me Hit It",
          artistName: "Bai-ee Edit",
          src: "https://github.com/Bai-ee/public_audio/raw/main/LET%20ME%20HIT%20IT_Bai-ee_clip.mp3",
      }, 
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-gray-800">
      <img src="https://i.ibb.co/w7xMd7f/Instagram-post-9.jpg"
    ...
    <div className="mt-6 relative">
      ...
      {/* // */}
        ...
        <div className="edit_button_muted">
          ...
          <button className="uppercase leading-tight h-4 mt-auto text-sm">EDIT</button></a>
        </div>
      {/* // */}
