...
import ShopifyBuyButton_Decongestion from './ShopifyBuyButton_Decongestion'; // Import the module


interface DecongestionProps {
  genre:string[];// Adding a genre prop
  // Include other props if there are any
}

const Release_Decongestion: React.FC<DecongestionProps> = ({ genre }) => {
...
type musicData = {
    ...
    const musicTracks: musicData[] = [
        {
          trackName: "Decongestion",
          artistName: "Secret Studio aka Bai-ee & Tyrel WIlliams",
          src: "https://github.com/Bai-ee/public_audio/raw/main/Secret%20Studio%20-%20Decongestion.mp3",
        }
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-gray-800">
      <img src="https://i.ibb.co/BTXtD2X/82-F03-AF3-650-A-46-A3-AAB3-20-EB819868-ED.png"
...
export default Release_Decongestion;
