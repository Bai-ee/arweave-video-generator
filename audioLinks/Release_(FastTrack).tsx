...
import ShopifyBuyButtonFastTrack from './ShopifyBuyButton_FastTrack'; // Import the module
...
const Release_FastTrack: React.FC<FastTrackProps> = ({ genre }) => {
    ...
    const musicTracks: musicData[] = [
        {
          trackName: "TEST",
          artistName: "Bai-ee",
          src: "https://github.com/Bai-ee/public_audio/raw/main/FastTrack_Clip.mp3",
        },  
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-black">
      <img src="https://i.ibb.co/wyG9DgH/IMG-6117.jpg"
...
export default Release_FastTrack;
