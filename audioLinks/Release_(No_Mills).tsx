...
import ShopifyBuyButton from './ShopifyBuyButton_No_Mills'; // Import the module

import et004 from './et004.jpg'; // Import the image
{/* <img src={et005} */}
interface NoMillsProps {
  genre: string[]; // Adding a genre prop
  // Include other props if there are any
}

const No_Mills: React.FC<NoMillsProps> = ({ genre }) => {
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    ...
    <img src={et004}
      alt="art cover" loading="lazy" className="w-full w-full object-cover object-top transition duration-500 group-hover:scale-105" />    
    </div>
...
className="
font-mathias outline_button_main text-center w-34 py-4 
mb-2 rounded-md mb-0 shadow-2xl
hover:opacity-50 font-mathias md:mt-0 w-full
...
{/* bandcamp */}
<a href="https://secretstudiosftd.bandcamp.com/track/b1-no-mills" target="_blank" rel="noopener noreferrer" className="">
<div className="hover-50 w-8 h-8 bg-yellow-75  border-2 border-yellow-75 rounded-md">
...
<div className="hover-50 w-8 h-8 bg-yellow-7  border-2 border-yellow-755 rounded-md">
...
<img  className="rounded-md" src="https://i.postimg.cc/zXVR2kwB/apple-7446229-960-720.png"></img>
</div>
{/* </a> */}
</div>


<div className="text-justify text-yellow-75">
  {/* This original version tape release was edited out of a live, extended session on my modular rig.
  It was the first time I recorded a session with the intention of chopping it up into individual
  trax for a release.
  <br></br><br></br>I was really happy with the way it turned out and it heavily influenced my 
  production process moving forward. It had me rethink how I approached music making, enjoying a
  focus on capturing moments in time on the rig, vs. building tracks in digital audio
  workstations. <br></br>
  <br></br>
  Originally released with Tram Planet Recordings, this original tape version has a section not
  available in the EditTrax collectible. */}
</div>
...
PRODUCER: Secret Studio<br></br>
RELEASE: SFTD <br></br>
EDIT: Release Version<br></br>
</div>
...
LABEL: Tram Planet<br></br>
YEAR: 2023 |
BPM: 122<br></br>GENRE: Acid Techno<br></br>
</div>
</div>
<div className="flex flex-row w-full justify-center p-2 pb-0 rounded-md gap-2 px-0 mt-4">
<div  className="p-1 playButtonCont justify-left h-20 w-full 
...
<img  className="rounded-md w-30 " src="https://i.postimg.cc/DfNYcpxf/verrt_logo_w_head.png"></img>
</div>
<div className="p-1 playButtonCont justify-left h-20 w-full border
...
<a href="https://edittrax.com/preview/et004" target="_blank" 
