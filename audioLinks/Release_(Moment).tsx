...
import ShopifyBuyButton_Moment from './ShopifyBuyButton_Moment'; // Import the module
...
const Release_Moment: React.FC<MomentProps> = ({ genre }) => {
    ...
    const musicTracks: musicData[] = [
        {
          ...
          src: "https://github.com/Bai-ee/public_audio/raw/main/Secret%20Studio%20-%20Moment.mp3",
        },
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-gray-800">
      <img src="https://i.ibb.co/wMZ537x/3-CED566-D-5-EEB-4241-8-EAB-D145300-B95-BC.png"
