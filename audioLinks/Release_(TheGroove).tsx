...
import ShopifyBuyButtonTheGroove from './ShopifyBuyButton_TheGroove'; // Import the module


interface TheGrooveProps {
  genre: string[]; // Adding a genre prop
  // Include other props if there are any
}

const Release_TheGroove: React.FC<TheGrooveProps> = ({ genre }) => {
    ...
    const musicTracks: musicData[] = [
        {
          trackName: "TEST",
          artistName: "Bai-ee",
          src: "https://github.com/Bai-ee/public_audio/raw/main/Bai-ee_Hancock_Groove_Poontin_Muzik.mp3",
        },  
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-black">
      <img src="https://i.ibb.co/sVm96DF/IMG-6304.jpg"
...
export default Release_TheGroove;
