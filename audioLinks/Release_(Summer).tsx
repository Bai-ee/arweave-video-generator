...
import ShopifyBuyButton_Summer from './ShopifyBuyButton_SummerNights'; // Import the module
...
const Release_Summer: React.FC<SummerProps> = ({ genre }) => {
    ...
    const musicTracks: musicData[] = [
        {
          trackName: "Summer",
          artistName: "Bai-ee",
          src: "https://github.com/Bai-ee/public_audio/raw/main/Summer_City_(audioJazz)_preview.mp3",
      }, 
      ];
...
<div className="group p-6 sm:p-8 rounded-md border bg-transparent
  border-yellow-75 dark:shadow-none shadow-2xl shadow-gray-600/10">
    <div className="relative overflow-hidden rounded-xl bg-gray-800">
      <img src="https://i.ibb.co/thyJjyw/5-E6-BCA8-E-C292-46-BD-95-A7-DF96-BB0-BFBF7-1.png"
