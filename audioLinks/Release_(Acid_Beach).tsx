...
import ShopifyBuyButton from './ShopifyBuyButton'; // Import the module

import et001 from './et01hand.jpg'; // Import the image
{/* <img src={et005} */}


interface AcidBeachProps {
  genre: string[]; // Adding a genre prop
  // Include other props if there are any
}

const Release_Acid_Beach: React.FC<AcidBeachProps> = ({ genre }) => {
...
export default Release_Acid_Beach;
